    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        switch (type){
            ...
            case Constants.BUILDING:
                holder.img.setImageResource(R.drawable.item_building);
                break;
            ...
            case Constants.USER:
                ...
                holder.setOnclick(x,y,Constants.USER);
                break;
            case Constants.OTHERUSER:
                holder.img.setImageResource(R.drawable.item_orther_user);
                holder.img.startAnimation(AnimationUtils.loadAnimation(context, R.anim.anim_current_location));
                break;
            case Constants.END:
                break;
            case Constants.DIRECTION:
                ...
                holder.setOnclick(x,y,Constants.DIRECTION);
                break;
