...
--
-- Table structure for table `guest_location`
--

DROP TABLE IF EXISTS `guest_location`;
...
--
-- Dumping data for table `guest_location`
--

LOCK TABLES `guest_location` WRITE;
/*!40000 ALTER TABLE `guest_location` DISABLE KEYS */;
/*!40000 ALTER TABLE `guest_location` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `staff` VALUES (0,'TNV','Tình nguyện viên','2000-02-02','0','Every Where','TNV',1,'TNV','TNV',0,0),(1,'QL_01_LinhPH','Phạm Hải Linh','1996-11-30','01667645238','Bạch Mai - Hà Nội','MANAGER',1,'linhph','linhph',0,0),(2,'NV_01_TUNGTS','Trần Sơn Tùng','1996-12-09','01685423584','Đại La - HBT - Hà Nội','STAFF',1,'tungts','tungts',0,0),(3,'NV_02_THANHNV','Nguyễn Văn Thanh','1996-06-03','01689745875','Đại La - HBT - Hà Nội','STAFF',1,'thanhnv','thanhnv',0,0),(4,'TNV','Tình nguyện viên','2000-02-01','0','Every Where','TNV',1,'ducnv','ducnv',0,0);
...
INSERT INTO `tree_type` VALUES (1,'Sấu 2',250,800,0.5,0),(2,'Bàng',25,80,0.5,1),(3,'Phượng',25,80,0.5,1),(4,'Xà cừ',25,80,0.5,1),(5,'Sấu',25,80,0.5,1),(6,'Sấu 2',250,800,0.5,1);
...
-- Dump completed on 2018-04-09 23:02:56
